...
namespace spaceflight_simulator.messages
{
    public class TestServerMessage : network_objects.Message
    {
        ...
        public TestServerMessage(network_objects.datatypes.String name, network_objects.datatypes.Vector3 position, network_objects.datatypes.Vector3 velocity) : this()
        {
